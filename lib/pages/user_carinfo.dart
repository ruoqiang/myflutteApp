...
class UserCarInfoPage extends StatefulWidget {
  @override
  _UserCarInfoState createState() => _UserCarInfoState();
}

class _UserCarInfoState extends State<UserCarInfoPage> {
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: Text('车辆信息',style: TextStyle(color: Color(0xff2D4ED1),fontSize: 14)),
          ),
          Text('证件照片'),
        ],
      ),
